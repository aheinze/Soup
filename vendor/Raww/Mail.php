...
class Mail {
	...
	public function send() {
		...
		$boundryMixed = 'RawwPHP-mixed-' . $random_hash;	// Boundry for mixed content type (ie. Text and File Attachments)
		$boundryAlt   = 'RawwPHP-alt-' . $random_hash;		// Boundry for Alternative mail types (ie. plain and html)
