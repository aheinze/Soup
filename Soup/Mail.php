...
class Mail {
	...
	public function send() {
		...
		$boundryMixed = 'SoupPHP-mixed-' . $random_hash;	// Boundry for mixed content type (ie. Text and File Attachments)
		$boundryAlt   = 'SoupPHP-alt-' . $random_hash;		// Boundry for Alternative mail types (ie. plain and html)
