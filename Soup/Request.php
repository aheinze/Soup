...
if (function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc()) {
	...
	Request::$_POST    = array_map('\Soup\stripslashes_deep', $_POST);
	Request::$_GET     = array_map('\Soup\stripslashes_deep', $_GET);
	Request::$_COOKIE  = array_map('\Soup\stripslashes_deep', $_COOKIE);
	Request::$_REQUEST = array_map('\Soup\stripslashes_deep', $_REQUEST);
